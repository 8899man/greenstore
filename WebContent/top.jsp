 <%@page import="com.oracle.greenstore.modle.been.User"%>
...
<div class="top1">
<div class="top1_main">
<span class="dl"><div style="float: left;">您好，欢迎光临本亲生活网！</div>
<% 
...
<a href="zhuce.jsp">[免费注册]</a>
		...
		%>
		<div style="float: left;"><a><%=resultUser.getUser_name() %></div><div style="width: 27px;height: 27px;float: left;border-radius: 13px;background-image: url(<%=resultUser.getTouxiang()%>);background-size: contain"></div></a>
		<%
	}
%>
</span>
<span class="yh_zx"><a href="hyzx.jsp">用户中心</a>  |  <a href="ShopingWineServlet?method=getWineFromCookie">我的订单</a>  |  <a href="#">帮助中心</a>  |  <a href="#">联系方式</a>  |  <a href="UserServlet?method=tuichu">退出</a></span></div>
</div>
...
<div class="ss_1"><form action="editQurey.jsp"><input name="key" type="text" id="key" value="请输入您要搜索的产品" size="30"      
          onclick="if(value==defaultValue){value='';this.style.color='#898b8c'}"    
          onBlur="if(!value){value=defaultValue;this.style.color='#999'}" style="color:#999; line-height:26px;" / class="ssk1"><input name="" value="搜 索" type="submit" / class="button1" ></form></div>
  ...
  <div class="navCon w1020">
    ...
    <div class="navCon-menu fl">
      <ul>
        ...
        <li><a href="WineServlet?method=tplistPages&page=1&count=9">特色产品</a></li>
